...
<section class="pf-c-page__main-section pf-m-light">
    <div class="pf-c-content">
        ...
        <p>The hard-coded IP report lists the places where an IP address is found in the application. This may include places where the IP address is specified directly in the code rather than externalized into the configuration files.</p>
    </div>
</section>
